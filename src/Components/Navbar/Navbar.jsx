  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
      ...
      >
        ...
        <a href="#Skill">
          <li className="text-md transition-all duration-300 p-1 md:p-0">Skills And Experience</li>
        </a>
        <a href="#Projects">
        ...
        {/* My Resume Button */}
        <a
          href="https://drive.google.com/uc?export=download&id=1htCguGMh_EJuefkw_-Xe5UalLnRiCG32"
          target="_blank"
